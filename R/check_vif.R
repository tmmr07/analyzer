...
check_vif <- function(map_features, response_variable, output_path, data_type) {
  ...
  while (TRUE) {
    ...
    temp_formula_str <- paste("rsl21_rate ~", paste(current_predictor_names, collapse = " + "))
    ...
    formula_str <- paste("rsl21_rate", "~", predictor_formula_part)
